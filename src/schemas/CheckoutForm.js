...
export const formValidationSchema = Yup.object({
  firstName: Yup.string()
    ...
    .matches(nameRegex, "First name shouldn't include any special character"),
  ...
  lastName: Yup.string()
    ...
    .matches(nameRegex, "Last name shouldn't include any special character"),
